        ...
        <div className="w-full h-screen flex flex-col lg:flex-row">
            ...
            >
                ...
                <div className="w-full md:w-3/4 mb-6">
                    <p className="text-xl font-semibold mb-4 text-black text-left">Select Login Type</p>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                        {['Team', 'Evaluator', 'Admin'].map((role) => (
                            <button
                                key={role}
                                onClick={() => setSelectedRole(role)}
                                className={`py-3 rounded-xl cursor-pointer lg:px-2 font-semibold border transition-all 
                  ${selectedRole === role
                                        ? 'bg-[#db5422] text-white'
                ...
                <MotionLink
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="bg-[#db5422] text-white w-full md:w-1/2 py-3 cursor-pointer text-lg rounded-xl hover:bg-[#c64619] transition text-center"
                >
                    Login
                </MotionLink>
                {/* Signup Link */}
